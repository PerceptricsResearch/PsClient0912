<div id="surveyplayercontainer"  
   ...
   <div style="position:relative;min-height:360px;min-width:400px;">
   <div id="surveyplayerroot"
        style="padding-left:15%;padding-right:15%;margin-top:1em;margin-bottom:1em;position:relative;">
             ...
             <div class="surveyplayersurveypage" 
                  ...
                  <div id="surveyplayersurveypage0"  class="surveyplayersurveyitem"
                       ...
                       <div data-bind="html: $data.modelcore.html, attr: { 'id': $data.pcelemID } "
                            class="pcelem"
                            style="position:absolute;min-height:40px;" /></div>
             </div>
             <div class="surveyplayersurveypage"
                  data-scale="1"
                  style="display:inline-block;
