    ...
    <div id="guesthcpwrapper" >
        <div id="guesthomecenterpanel" class="guesthomecenterpanelitems">
            <div id="guesthcpsurveyhost" class="prwslideouthide" 
                 ...
                 @Html.Partial("ResultsSurveyViewPartial")
...
@section scripts 
    ...
    <script src="@Url.Content("~/Scripts/prweb.guestplatformresults.js")" type="text/javascript"></script>
<script  type="text/javascript"> 
   (function (prweb, $) {
       $('#guestplatformlayoutroot').guestplatformresults({
