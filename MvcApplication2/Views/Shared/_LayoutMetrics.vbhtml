...
<head>
    ...
    <link href="@Url.Content("~/Content/metricsportal.css")" rel="stylesheet" type="text/css" />
...
<body    style="position:absolute;top:0;bottom:0;left:0;right:0;
    ...
    <div id="metricspagefooter">
         <div style="position:relative;margin-top:0.75em;font-size:0.5em;text-align:center;">
        Metrics Services Portal
        Copyright 2011 Perceptrics Research LLC
        @Date.Now.ToLongTimeString</div>
    </div>
